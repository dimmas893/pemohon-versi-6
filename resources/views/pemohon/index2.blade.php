                ...
                <div class="my-2">
                    <div class="container">
                        <ul class="nav nav-pills nav-fill mb-2" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-2" role="tab">Isi Persyaratan</a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="tab-pane fade my-2" id="pills-2" role="tabpanel" aria-labelledby="pills-profile-tab">
                <div class="container">
                    <ul class="nav nav-pills nav-fill mb-2" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" id="pills-profile-tab" data-toggle="pill" href="#pills-2" role="tab">Isi Persyaratan</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-3" role="tab">Pratinjau</a>
                        </li>
            ...
            <div class="tab-pane fade my-2" id="pills-3" role="tabpanel" aria-labelledby="pills-contact-tab">
                ...
                <div class="card-body">
                    <div class="card">
                        ...
                        <div class="ml-3">
                            <label for="">Email :  @{{ getPotong(isiemail) }}</label>
                        </div>
                        <div class="ml-3">
